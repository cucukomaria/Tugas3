...
<form action=""method="post">
    <p> berapa hasil bilangan dari 10-7=?</p>
    <input type="number"name="ans1">
    <p> berapa hasil dari bilangan 6+10=?</p>
    <input type="number"name="ans2">
    <p> berapa hasil dari bilangan 7+8=?</p>
    <input type="number"name="ans3">
    <p> berapa hasil dari bilangan 9-4=?</p>
    <input type="number"name="ans4">
    <p> berapa hasil dari bilangan 10-5=?</p>
    ...
    <?php 
        if (isset($_POST['submit'])){
            ...
            $kunci_jawaban = array(3, 16, 15, 5, 5);
